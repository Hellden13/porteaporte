...
function _ogBuildSvg(ride) {
  ...
  ${_ogText(dateLine, 80, 492, 30, '#B8C4D6')}
  <rect x="80" y="520" width="${priceW}" height="66" rx="33" fill="url(#acc)"/>
  ${_ogText(priceLabel, 80 + priceW / 2, 563, 34, '#0A0F1E', { bold: true, anchor: 'middle' })}
  ${_ogText(seatsLabel, 80 + priceW + 34, 563, 30, '#8A9BB0')}
  ${_ogText('porteaporte.site', 1120, 598, 24, '#56657D', { anchor: 'end' })}
</svg>`;
}
