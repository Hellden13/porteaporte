...
async function safeMeetingPoints(req, res, ctx, body) {
  ...
  let filter = 'active=eq.true&order=verified.desc,name.asc&limit=100';
  ...
  const fullCols = 'id,name,type,address,city,sector,lat,lng,verified,hours,notes,photo_url,has_cameras,well_lit,parking_free';
