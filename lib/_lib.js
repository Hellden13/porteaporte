...
function roleIn(profile, roles) {
  ...
  if (profileHasCapabilityColumns(profile)) {
    if (wanted.includes('admin')) return false;
    if (wanted.includes('les deux') && hasCapability(profile, 'est_livreur') && hasCapability(profile, 'est_expediteur')) return true;
    if (wanted.includes('livreur') && hasCapability(profile, 'est_livreur')) return true;
    if (wanted.includes('expediteur') && hasCapability(profile, 'est_expediteur')) return true;
    return false;
  }
